...
const projects = [
  {
    ...
    description: "Realtime ops dashboard for a global logistics network with adaptive alerts and AI copilots.",
    src: "helix.jpg",
  ...
  },
  {
    ...
    description: "Patient-first care platform with biometric monitoring and collaborative care plans across devices.",
    src: "pulse.jpg",
  ...
  },
  {
    ...
    description:
      "Quant research workspace with interactive 3D trade flows, scenario tools, and live compliance guardrails.",
    src: "arclight.jpg",
  ...
  },
  {
    ...
    description: "Developer hub with interactive API sandboxes, live docs, and guided onboarding flows.",
    src: "photon.jpg",
    link: "https://images.unsplash.com/photo-1605106915994-18d3fecffb98?w=500&auto=format&fit=crop&q=60",
    color: "#ed649e",
  },
  {
    title: "Nova Commerce",
    description: "Headless commerce experience with adaptive pricing, 3D product viewers, and blazing-fast search.",
    src: "nova.jpg",
...
export default function StackedProjects(): React.ReactNode {
      ...
      <main className="bg-slate-950" ref={container}>
        <section className="text-white h-[70vh] w-full bg-slate-950 grid place-content-center">
          ...
          <h1 className="2xl:text-7xl text-5xl px-8 font-semibold text-center tracking-tight leading-[120%]">
            Featured Projects <br /> Scroll down! 👇
          </h1>
        </section>
        ...
        <div className={`flex h-full mt-5 gap-10`}>
          <div className={`w-[40%] relative top-[10%]`}>
            ...
            <span className="flex items-center gap-2 pt-2">
              <a href={"#"} target="_blank" className="underline cursor-pointer" rel="noreferrer">
                See more
              </a>
          ...
          <div className={`relative w-[60%] h-full rounded-lg overflow-hidden `}>
            <motion.div className={`w-full h-full`} style={{ scale: imageScale }}>
              <Image fill src={url || "/placeholder.svg"} alt={title} className="object-cover" />
            </motion.div>
          </div>
        </div>
      </motion.div>
